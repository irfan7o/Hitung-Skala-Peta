...
<html>
    <head>
        <title>Hitung Jarak pada Peta</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div id="depan" >
            <div id="judul">
                <h1 style="font-family: Comic Sans MS, cursive, sans-serif; color: white;">Hitung Jarak pada Peta</h1>
              ...
              ?>
                        <tr>
                            <td><input placeholder="Hasil" value="<?php echo $Jp; ?>" type="text" class="tbtl" disabled/><a style="font-weight: bold; color: white;"> Cm</a></td>
                        </tr>
                    </table>
                </form>
                <div id="hasil" style="text-align: center;">
               <?php
              echo 'Jadi, jarak pada peta adalah ';echo number_format($Jp,0,",",".");echo' Cm ';
              ?><br>
              </div>
            </div>
        </div>
